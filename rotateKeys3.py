...
def main():
    ...
    parser.add_argument("-d", "--delete", help="Deletes an access key", action="store_true")
    ...
    try:
        ...
        print ("you need to use the proper arguments i.e python3 rotateKeys3.py -u username@salesforce.com -p profile ")
